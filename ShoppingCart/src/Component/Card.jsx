...
function CardGrid({ setCartValue }) {
  const cardData = [
    { name: 'Floral top', rating: '⭐⭐⭐⭐⭐', price: '₹250-₹280',img1:true },
    { name: 'Trousers', rating: '⭐⭐⭐⭐⭐', originalPrice: '₹130', price: '₹60', isSpecial: true ,img2:true},
    { name: 'Co-ord Set', rating: '⭐⭐⭐⭐⭐', price: '₹749', isSale: true,img3:true },
    { name: 'Belt', rating: '⭐⭐⭐⭐⭐', price: '₹40-₹80',img4:true },
    { name: 'Black Top',  rating: '⭐⭐⭐⭐⭐',price: '₹349-₹560', isSale: true ,img5:true},
    { name: 'Leggings', rating: '⭐⭐⭐⭐⭐', price: '₹140-₹180',img6:true },
    { name: 'Bracelets', rating: '⭐⭐⭐⭐⭐', originalPrice: '₹45', price: '₹18', isSoldout: true,img7:true },
    { name: 'Ring', rating: '⭐⭐⭐⭐⭐', price: '₹54',img8:true },
  ];
